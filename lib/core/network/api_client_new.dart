...
import 'package:digital_wallet/core/exception_handler/peding_request.dart';
...
class ApiClient {
  ...
  Future<Response> get(String endpoint, {Map<String, dynamic>? queryParameters, CancelToken? cancelToken, bool deduplicate = true}) async {
