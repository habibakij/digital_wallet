...
import 'package:digital_wallet/features/auth/domain/usecases/login_usecase.dart';
import 'package:digital_wallet/features/auth/domain/usecases/logout_usecase.dart';
...
import 'package:digital_wallet/features/send_money/domain/usecase/send_money_usecase.dart';
...
Future<void> configureDependencies() async {
  ...
  // ─── Auth ──────────────────────────────────────────────────────────────────
  sl.registerLazySingleton<AuthRemoteDataSource>(() => AuthRemoteDataSourceImpl(sl<ApiClient>(), sl<TokenStorage>()));
  sl.registerLazySingleton<AuthRepository>(() => AuthRepositoryImpl(sl<AuthRemoteDataSource>(), sl<TokenStorage>()));
