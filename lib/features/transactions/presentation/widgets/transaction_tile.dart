...
// old class all are include in transaction entity but not use in ui, so i comment it for future use
/*
class TransactionTile extends StatelessWidget {
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                fontSize: 15,
                color: transaction.isCredit ? AppColors.accentColor : AppColors.textPrimary,
              ),
            ),
            const SizedBox(height: 4),
            _buildStatusBadge(),
